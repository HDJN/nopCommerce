...
namespace Nop.Services.Orders
{
    ...
    public partial class OrderProcessingService : IOrderProcessingService
    {
        ...
        public virtual void UpdateOrderTotals(UpdateOrderParameters updateOrderParameters)
        {
            ...
            var unusedDiscounts = discountUsageHistoryForOrder.Where(history => !updateOrderParameters.AppliedDiscounts.Any(discount => discount.Id == history.DiscountId)).ToList();
            foreach (var historyItem in unusedDiscounts)
            {
                _discountService.DeleteDiscountUsageHistory(historyItem);
            }
